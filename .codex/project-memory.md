...
- Active synchronized test build: `NewWorldCore-1.21.1-NeoForge-0.5.59.10-alpha-radar-random-spread.jar` (SHA-256 `876bc247597c0186bced715b05e843e9a85b00f32d3a9c81c990d6134fd63687`). It is installed and runtime-accepted on the desktop instance; laptop installation remains pending.
