...
- Active runtime-accepted laptop build: `NewWorldCore-1.21.1-NeoForge-0.5.62.0-alpha-geological-field-survey.jar` (SHA-256 `253ba89166c0a6fc3e2cfb26d5a053e77a2075335702fafb0c714d997fe62bb5`). Build, config/discovery/geological-survey smoke, bytecode, backup, repository/laptop single-JAR/hash, eleven-property-file, launch, physical evidence, NBT persistence, source/visited/analysis upgrade, first-time preservation, and clean-log checks passed.
...
- The next work is anomaly → metallic → resource-rich → exact deposit-family analysis progression.
