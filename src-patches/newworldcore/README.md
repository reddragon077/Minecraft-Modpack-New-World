...
- recompiles only the existing compatibility class `Navigation0570MekanismDepositMaterializer`;
...
Build with `tools/build-newworldcore-geology-patch.ps1`. The script verifies the baseline SHA-256 before producing a new JAR.
